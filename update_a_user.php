...
$select = $con->prepare("SELECT * FROM cadastrados where id='$edit_user_id' ");
...
$update = $con->prepare("UPDATE cadastrados SET email=:email ,senha=:senha where id='$edit_user_id'");
